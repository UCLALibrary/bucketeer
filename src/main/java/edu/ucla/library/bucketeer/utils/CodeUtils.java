...
public final class CodeUtils {
    ...
    public static int getInt(final String aMessageCode) throws IllegalArgumentException {
        try {
            ...
            throw new IllegalArgumentException(LOGGER.getMessage(MessageCodes.BUCKETEER_135, aMessageCode), details);
        }
    }
    ...
    public static String getCode(final int aMessageCode) {
        final String prefix = MessageCodes.BUCKETEER_000.substring(0, MessageCodes.BUCKETEER_000.indexOf('-'));
