...
* A [Slack](https://slack.com/) Team, and a Slack [app](https://api.slack.com/start/overview), with at least one channel [configured to support file uploads](https://api.slack.com/messaging/files/setup) from that app.
